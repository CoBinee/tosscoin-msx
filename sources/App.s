...
appColorTable:
    ...
    .db     (VDP_COLOR_WHITE       << 4) | VDP_COLOR_BLACK, (VDP_COLOR_WHITE       << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_WHITE       << 4) | VDP_COLOR_BLACK, (VDP_COLOR_WHITE       << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_CYAN        << 4) | VDP_COLOR_WHITE, (VDP_COLOR_LIGHT_RED   << 4) | VDP_COLOR_WHITE
    .db     (VDP_COLOR_DARK_YELLOW << 4) | VDP_COLOR_WHITE, (VDP_COLOR_LIGHT_GREEN << 4) | VDP_COLOR_WHITE
    .db     (VDP_COLOR_WHITE       << 4) | VDP_COLOR_BLACK, (VDP_COLOR_WHITE       << 4) | VDP_COLOR_BLACK
    .db     (VDP_COLOR_WHITE       << 4) | VDP_COLOR_BLACK, (VDP_COLOR_WHITE       << 4) | VDP_COLOR_BLACK
